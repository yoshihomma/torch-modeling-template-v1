from albumentations.augmentations import MedianBlur as AlbumentationsMedianBlur

from ..data_container import DataContainer
from .transform_base import TransformBase


class MedianBlur(TransformBase):
    def __init__(
        self,
        blur_limit: int,
        ...
        self.motion_blur = AlbumentationsMedianBlur(
